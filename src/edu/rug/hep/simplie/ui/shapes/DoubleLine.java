...
public class DoubleLine implements Shape{
     ...
     * 
     */
    public DoubleLine(Point2D begin, Point2D end, int spacing) {
        this.x1 = begin.getX();
        this.y1 = begin.getY();
        this.x2 = end.getX();
        this.y2 = end.getY();
    ...
    private void initArrow(){
        ...
        poly.addPoint((int) x1, (int) y1-2);
        poly.addPoint((int) x1 + length/2-5, (int) y1-spacing/2);
        poly.addPoint((int) x1 + length/2+5, (int) y1-spacing/2-5);
        poly.addPoint((int) x1 + length/2-5, (int) y1-spacing/2);
        poly.addPoint((int) x1 + length/2+5, (int) y1-spacing/2+5);
		poly.addPoint((int) x1 + length/2-5, (int) y1-spacing/2);
